...
export function InfoTip({ definition }: InfoTipProps) {
  const { t } = useLocale();
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="absolute left-0 top-6 z-50 w-56 rounded-xl border border-border-soft bg-surface-3 px-3 py-2.5 text-[12px] leading-relaxed text-ink-dim shadow-lg"
            >
              {definition}
            </motion.div>
          </>
